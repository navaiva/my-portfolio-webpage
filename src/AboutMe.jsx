  ...
  return (
    <div className="aboutMe" >
      ...
      <h1 className="about">
        ...
        improving my skills to create creative and interactive UI to improve the
        experience of the user, but I also enjoy working on the Back-end.
      </h1>
      <h1 className="about">
      ...
      <h1 className="about">
        ...
        hang out with friends, and visit amazing places like forests, beaches,
